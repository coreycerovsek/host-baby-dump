...
function Lytebox(bInitialize, aHttp) {
	...
	/*** Configure HTML Content / Media Viewer Options ***/
		...
		this.__width			= '88%';		// default width of content viewer
		this.__height			= '88%';		// default height of content viewer
...
Lytebox.prototype.start = function(oLink, bSlideshow, bFrame) {
	...
	// HOSTBABY FIX - pause on start, recreating old version functionality
...
Lytebox.prototype.showContent = function() {
	if (this.isSlideshow) {
		if(this.contentNum == (this.slideArray.length - 1)) {
			// HOSTBABY FIX - don't start loop when loading last pic
			//if (this.loopSlideshow) {
			if (this.loopSlideshow && !this.isPaused) {
